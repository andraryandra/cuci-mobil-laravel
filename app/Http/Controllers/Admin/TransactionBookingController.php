...
{
    // $booking = BookingCuci::with('kategoriMobil')->findOrFail($id);

    // $pdf = new Dompdf();
    // $pdf->loadHtml(view('admin.transaksi.kwitansi', compact('booking')));
    // $pdf->setPaper('A4', 'portrait');
    // $pdf->render();
    // $pdfContent = $pdf->output();

    // return view('admin.transaksi.pdf', compact('pdfContent'));
