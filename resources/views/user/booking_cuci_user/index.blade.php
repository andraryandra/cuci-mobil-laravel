...
@section('contentUser')
                                            ...
                                            <td class="text-center">
                                                @if ($item->status_pesan == 'PENDING')
                                                    <span class="badge bg-warning text-light p-2">
                                                        <i class="fa fa-spin fa-circle-o-notch mr-1"></i> Menunggu Cucian
                                                    </span>
                                                @elseif ($item->status_pesan == 'PROCESS')
                                                    <span class="badge bg-primary text-light p-2">
                                                        <i class="fa fa-spin fa-spinner mr-1"></i> Sedang Dicuci
                                                    </span>
                                                @elseif ($item->status_pesan == 'SUCCESS')
                                                    <span class="badge bg-success text-light p-2">
                                                        <i class="fa fa-check-square mr-1"></i> Pencucian Selesai
                                                    </span>
                                                @endif
                                            </td>
                                            <td class="text-center">
    ...
    @include('user.booking_cuci_user.show')
@endsection
