@foreach ($bookings as $item)
    ...
    {{-- <div class="modal fade" id="modalShow{{ $item->id }}" tabindex="-1" role="dialog"
        aria-labelledby="modalShow{{ $item->id }}Label" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_telp_pemesan" name="no_telp_pemesan" readonly
                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="user_id" class="form-label">Nama Pemesan</label>
                            {{-- <select class="custom-select" id="user_id" name="user_id" disabled required>
                                <option value="{{ $item->user->id }}">{{ $item->nama_pemesan }}</option>
                            </select> --}}
                            <input type="text" class="form-control" id="nama_pemesan" name="nama_pemesan" readonly
