...
@section('contentAdmin')
    ...
    @include('admin.landingPage.contact.edit')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('contact-landing-page.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mt-3">
                            <label for="image_contact" class="form-label">Image Contact</label>
                            <input type="file" name="image_contact" id="image_contact" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="title_contact" class="form-label">Title Contact</label>
                            <input type="text" name="title_contact" class="form-control" id="title_contact"
                                placeholder="Title Contact" required>
                        </div>
