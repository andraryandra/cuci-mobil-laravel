     ...
     @elseif (Request::routeIs('landingPage*.contact'))
        ...
        <div class="template-header-top">
            ...
            <div class="template-header-top-logo">
                <a href="{{ url('/') }}" title="">
                    <img src="{{ asset('landing-page/assets/media/image/logo.png') }}" alt=""
                        class="template-logo" />
                    <img src="{{ asset('landing-page/assets/media/image/logo_sticky.png') }}" alt=""
            ...
            @if (Request::routeIs('landingPage.home'))
                <div id="rev_slider_wrapper" class="rev_slider_wrapper fullwidthbanner-container">
                    ...
                    <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                        <ul>
                            <!-- Slide 1 -->
                            <li data-index="slide-1" data-transition="fade" data-slotamount="1" data-easein="default"
                                data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
                                <!-- Main image -->
                                <img src="{{ asset('landing-page/assets/media/image/slider/slider_01.jpg') }}"
                                ...
                                <div class="tp-caption tp-resizeme"
                                    ...
                                    <a class="template-component-button template-color-white" href="#"
                                        title="Purchase Template">Purchase Template</a>
                                </div>
                            </li>

                            <!-- Slide 2 -->
                            <li data-index="slide-2" data-transition="fade" data-slotamount="1"
                                data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0"
                                data-delay="6000">
                                <!-- Main image -->
                                <img src="{{ asset('landing-page/assets/media/image/slider/slider_02.jpg') }}"
                                    alt="slide-2" data-bgfit="cover" data-bgposition="center bottom">
                                <!-- Layers -->
                                <!-- Layer 01 -->
                                <div class="tp-caption tp-resizeme"
                                    data-x="['center','center','center','center','center']"
                            ...
                            <!-- Slide 3 -->
                            <li data-index="slide-3" data-transition="fade" data-slotamount="1"
                                data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0"
                                data-delay="6000">
                                <!-- Main image -->
                                <img src="{{ asset('landing-page/assets/media/image/slider/slider_03.jpg') }}"
                                    alt="slide-3" data-bgfit="cover" data-bgposition="center bottom">
                                <!-- Layers -->
                                <!-- Layer 01 -->
                                <div class="tp-caption tp-resizeme"
                                    data-x="['center','center','center','center','center']"
